...
export type FieldLegendRow = {
  ...
  meaning: string;
  /** A value it takes, in italics after the meaning — a real-looking one, not a description; a node where one language's value is not enough (the declaration's legend, §369). */
  example?: ReactNode;
