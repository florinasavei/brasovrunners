 ...
 * lock and the languages are flags, and every item on the bar is a smaller square: 24 pixels
 ...
 * used only by the bar's items: the switch, the fold's summary, the marks, the lock and the
 * languages. It is a band, 360 up to `sm`, closed at both ends: MUI emits its own breakpoints'
