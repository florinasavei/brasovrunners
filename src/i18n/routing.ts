...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    /**
     * The emergency sheet (§NNN): every confirmed runner's phone, emergency contact and health
    ...
    /**
     * Everything held about one person (§NNN), looked up by address. The address never travels
