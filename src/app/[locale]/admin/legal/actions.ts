 ...
 * still in their boxes (`DECISIONS.md` §305): a legal text runs to tens of kilobytes, which is
 ...
 * Since §305 a refusal is the form's returned state rather than a redirect, so the reason comes
