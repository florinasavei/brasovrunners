...
export async function signDeclarationAction(form: FormData): Promise<void> {
  ...
  try {
    ...
    */
    ...
    /*
      Any other conflict is the registration's state (§420): it lapsed, was cancelled, went back to
      ...
      `?invalid=1` (§420, nit found in review): when the state is still signable — a
