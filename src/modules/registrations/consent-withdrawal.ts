...
/**
 * Withdrawing what was given on consent (§NNN; the owner: "in order to be GDPR compliant, we
 ...
 * (kept for M2, never asked since §NNN). The privacy notice promised "retractabilă oricând" for
