...
/**
 * Everything the platform holds about one person (§NNN) — the answer to an access request
 ...
 * each one is recorded as read (`registration.health_viewed`, §NNN) exactly as the section on
 ...
 * counts and never a value (§NNN). A file that leaves the application is a copy the erase cannot
