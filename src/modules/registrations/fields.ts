 ...
 * (§NNN) and defaults to false. No password field and no login link exist because none is in
...
const submissionFields = z.object({
   ...
   *
   * Optional since §NNN, with the city beside it. Nothing the club does with a registration
  ...
  /**
   * "My name may appear in the public results" (BR-REQ-072-01) — no longer asked (§NNN).
   *
