 ...
 *   CANCELLED, EXPIRED → no button at all, and a red line first (§305): the state, the date,
...
export default async function DeskRow({
  ...
  /*
    A registration that is over (§305). The state machine offers it nothing here — `canConfirm`
  ...
  */
  ...
  return (
    ...
    >
      {/*
        First and loudest (§305): before the name, before the number, in the error colour. The
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Stack direction="row" spacing={1} sx={{ alignItems: "center", flexWrap: "wrap", gap: 0.5 }}>
            {/*
              ...
              Struck through and dimmed on a row that is over (§305): the number is still this
          ...
          {/*
            ...
            Not on a row that is over (§305): the picture is for matching a bib to a runner, and
