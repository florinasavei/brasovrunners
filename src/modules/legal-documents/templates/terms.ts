...
export const termsEn: LegalDocumentBody = {
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Your name appears on an event's public participant list only if the club switches that list on for the event and you ticked that you want to when registering; the list shows the name from the form (or the display name, where allowed) and the club, nothing else. We do not publish results with names yet; when we do, we will ask you separately. You withdraw your agreement to the list at any time with one tap, from your confirmation email or “My registrations”, without losing the registration.",
