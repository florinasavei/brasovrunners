  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Pe o alergare de grup poți semna, dacă vrei, o declarație pe propria răspundere, pe pagina alergării; nu te înscrie nicăieri și nu e o condiție ca să alergi cu noi. Păstrăm numele scris ca semnătură, adresa de e-mail la care îți trimitem copia, amprenta textului și momentul semnării; tu și clubul primiți câte o copie pe e-mail. Dacă alergarea are o vârstă minimă peste 18 ani, îți cerem și data nașterii, doar ca să o verificăm; nu o păstrăm (după o semnare refuzată, rămâne cel mult zece minute, criptată, în browserul tău, ca să nu o scrii din nou). Temei: interesul nostru legitim de a putea dovedi că ai fost informat/ă despre riscurile alergării și că le-ai acceptat (art. 6(1)(f) GDPR), iar pentru afirmația despre sănătate, constatarea sau apărarea unui drept în instanță (art. 9(2)(f) GDPR); semnarea este voluntară și te poți opune oricând (secțiunea 8). Din baza de date o ștergem la șapte zile după alergare, iar copia din căsuța de arhivă a clubului la trei ani de la alergare.",
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "On a group run you may sign, if you wish, a self-declaration on the run's page; it registers you for nothing and is not a condition of running with us. We keep the name typed as the signature, the email address we send your copy to, the text's fingerprint and the moment of signing; you and the club each receive a copy by email. If the run has a minimum age above 18, we also ask for your date of birth, only to check it; we do not keep it (after a refused signing it stays, encrypted, in your browser for at most ten minutes, so you need not type it again). Basis: our legitimate interest in being able to show that you were informed of the run's risks and accepted them (art. 6(1)(f) GDPR), and for the statement about your health, the establishment or defence of legal claims (art. 9(2)(f) GDPR); signing is voluntary and you may object at any time (section 8). We delete it from our database seven days after the run, and the copy in the club's archive mailbox three years after the run.",
      ],
    },
    {
