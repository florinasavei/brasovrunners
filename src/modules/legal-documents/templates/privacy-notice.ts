 ...
 *
 * Rewritten by the GDPR transparency pass (§NNN): every item the platform keeps now has its
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Nota de sănătate (alergie, afecțiune, medicament) este o categorie specială de date, pe care o păstrăm numai cu consimțământul tău explicit, bifat separat (art. 6(1)(a) și art. 9(2)(a) GDPR), doar ca organizatorii cursei să știe ce e de făcut dacă ai nevoie de ajutor în ziua cursei. Nu este niciodată obligatorie. O văd doar organizatorii, pe pagina înscrierii și pe fișa de urgență a evenimentului; nu apare în exporturi, în e-mailuri sau în copiile trimise clubului. O retragi oricând din „Înscrierile mele”, fără să-ți pierzi locul.",
        "Păstrăm și istoricul înscrierii (stările, momentele, cine a făcut-o), numărul de concurs și prezența la start: art. 6(1)(b) GDPR; după încheierea înscrierii, art. 6(1)(f), ca dovadă că locurile s-au dat corect. Locurile și lista de așteptare le gestionează automat platforma, după o singură regulă pentru toți — ordinea confirmării adresei de e-mail; un loc ținut și nesemnat la timp (30 de minute, sau până la termenul de confirmare dinaintea cursei când evenimentul are unul, ori 24 de ore pentru o ofertă de pe lista de așteptare) trece automat următorului de pe lista de așteptare. Nu facem profiluri. Nu considerăm aceasta o decizie cu efecte juridice sau la fel de importante în sensul art. 22 GDPR, participarea fiind gratuită, dar poți cere oricând ca un om din echipă să verifice ce s-a întâmplat cu locul tău.",
        "Data nașterii ne arată și dacă ai vârsta minimă de participare, 14 ani împliniți în ziua evenimentului; nu înscriem pe nimeni mai tânăr. Un minor (14–17 ani; sub 18 ani la data înscrierii) este înscris de părinte sau de tutorele legal, cu datele copilului. Adresa de e-mail și telefonul din formular sunt de regulă ale părintelui, care primește astfel toate mesajele; păstrăm și numele părintelui, iar la semnare seria și numărul actului lui de identitate, pentru că el semnează declarația, dă consimțămintele în locul copilului (art. 8 GDPR) și ridică kitul — temei art. 6(1)(b) GDPR, aceleași termene ca mai jos. Pentru un minor nu păstrăm Strava sau Instagram, iar fotografii în care un copil apare în prim-plan publicăm doar cu acordul părintelui.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The health note (an allergy, a condition, a medicine) is special-category data, kept only with your explicit consent, ticked separately (art. 6(1)(a) and art. 9(2)(a) GDPR), only so the race organisers know what to do if you need help on race day. It is never required. Only the organisers see it, on the registration's page and the event's emergency sheet; it appears in no export, email or copy sent to the club. You withdraw it at any time from “My registrations”, without losing your place.",
        "We also keep the registration's history (states, moments, who acted), race number and check-in: art. 6(1)(b) GDPR; after the registration ends, art. 6(1)(f), as proof that places were given fairly. The platform manages places and the waiting list automatically, by one rule for all — the order in which email addresses are confirmed; a place held and not signed for in time (30 minutes, or until the confirmation deadline before the race where the event sets one, or 24 hours for a waiting-list offer) passes automatically to the next person on the waiting list. We do no profiling. We do not consider this a decision with legal or similarly significant effect under art. 22 GDPR, taking part being free, but you may always ask a person on the team to review what happened to your place.",
        "Your date of birth also tells us whether you meet the minimum age to take part, 14 on the day of the event; we register nobody younger. A minor (14 to 17; under 18 on the day of registering) is registered by a parent or legal guardian with the child's details. The email and telephone on the form are usually the parent's, who then receives every message; we also keep the parent's name and, at signing, their identity document's series and number, because the parent signs the declaration, gives the consents for the child (art. 8 GDPR) and collects the kit — basis art. 6(1)(b) GDPR, the same periods as below. For a minor we keep no Strava or Instagram, and photographs in which a child is the subject are published only with the parent's agreement.",
