 ...
 * deadlines. TODO(legal-code): these promises are the code chain's, and the club approves this
 * text only once they ship — the list closes by itself after `{{publicListPeriod}}` (a "Termene"
 * setting, checked at request time); §4's pending and waiting names are shown only for
