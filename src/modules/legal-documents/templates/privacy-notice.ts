 ...
 * a member gives is described ("the tick saying you are a member of the club"), not quoted with
 * the club's name in it. What stays written in is not the club's or an event's: the supervisory
 * authority's statutory contact (art. 13(2)(d) GDPR wants it) and the platform's own processors,
 * their regions and its retention periods, which are the same for every event.
 */
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Opțional, același temei: mărimea de tricou, clubul, un nume de afișare și bifa prin care spui că ești membru al clubului — neverificate, fără efect asupra locului.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Optional, same basis: t-shirt size, club, display name and the tick saying you are a member of the club — unverified, without effect on your place.",
