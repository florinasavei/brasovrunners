  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Pe o alergare de grup poți semna, dacă vrei, o declarație pe propria răspundere, pe pagina alergării; nu te înscrie nicăieri și nu e o condiție ca să alergi cu noi. Păstrăm numele scris ca semnătură, seria și numărul actului de identitate dacă declarația le cere, adresa de e-mail la care îți trimitem copia, amprenta textului și momentul semnării; clubul primește o copie pe e-mail, cu actul de identitate mascat. Temei: consimțământul tău, dat prin semnare (art. 6(1)(a) GDPR), pe care îl poți retrage oricând scriindu-ne — atunci ștergem declarația. Din baza de date o ștergem oricum la șapte zile după alergare.",
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "On a group run you may sign, if you wish, a self-declaration on the run's page; it registers you for nothing and is not a condition of running with us. We keep the name typed as signature, your identity document's series and number where the declaration asks, the email address we send your copy to, the text's fingerprint and the moment of signing; the club receives a copy by email, with the identity document masked. Basis: your consent, given by signing (art. 6(1)(a) GDPR), which you may withdraw at any time by writing to us — we then delete the declaration. We delete it from our database seven days after the run in any case.",
      ],
    },
    {
