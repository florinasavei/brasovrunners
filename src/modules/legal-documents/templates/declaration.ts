  ...
  sections: [
    {
      paragraphs: [
        ...
        "• Kitul de participare se ridică personal, pe baza actului de identitate menționat mai sus — pentru un participant minor sub 14 ani, al părintelui ori tutorelui legal; pentru unul de 14–17 ani, al lui și al părintelui ori tutorelui legal.",
  ...
  sections: [
    {
      paragraphs: [
        ...
        "• The race kit is collected in person, against the identity document named above — for a minor participant under 14, the parent's or legal guardian's; for one aged 14–17, their own and the parent's or legal guardian's.",
