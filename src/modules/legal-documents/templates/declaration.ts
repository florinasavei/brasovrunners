  ...
  sections: [
    {
      paragraphs: [
        ...
        "Această declarație este semnată electronic: numele scris mai jos, bifa de acceptare, momentul semnării și amprenta textului citit sunt înregistrate împreună (semnătură electronică simplă, în sensul Regulamentului (UE) nr. 910/2014 (eIDAS) și al Legii nr. 214/2024 privind utilizarea semnăturii electronice). O copie îmi este trimisă pe adresa de email confirmată, iar una, cu seria și numărul actului de identitate mascate (rămân doar primele două și ultimele două caractere), ajunge în arhiva clubului.",
