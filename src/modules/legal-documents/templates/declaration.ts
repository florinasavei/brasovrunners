  ...
  sections: [
    {
      paragraphs: [
        ...
        "De asemenea, sunt informat/ă că informațiile cu caracter personal furnizate în această declarație sunt prelucrate conform Regulamentului (UE) 2016/679 (GDPR) și notei de confidențialitate a clubului, exclusiv în scopul organizării și desfășurării acestui eveniment, și că sunt păstrate trei ani de la data evenimentului (seria și numărul actelor de identitate, șapte zile de la eveniment).",
