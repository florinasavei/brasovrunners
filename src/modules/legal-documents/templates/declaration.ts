  ...
  sections: [
    {
      paragraphs: [
        ...
        "De asemenea, sunt informat/ă că informațiile cu caracter personal furnizate în această declarație sunt prelucrate conform Regulamentului (UE) 2016/679 (GDPR) și notei de confidențialitate a clubului, exclusiv în scopul organizării și desfășurării acestui eveniment, și că sunt păstrate trei ani de la data evenimentului (seria și numărul actului de identitate, șapte zile de la eveniment).",
        "Această declarație este semnată electronic: numele scris mai jos, bifa de acceptare, momentul semnării și amprenta textului citit sunt înregistrate împreună (semnătură electronică simplă, în sensul Regulamentului (UE) nr. 910/2014 (eIDAS) și al Legii nr. 214/2024 privind utilizarea semnăturii electronice). O copie îmi este trimisă pe adresa de email confirmată.",
