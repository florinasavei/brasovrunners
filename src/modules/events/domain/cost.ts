 ...
 * §390). Only this combination reads "la organizator" / "to the organizer" and only this one
 ...
 * fee, one short line (`DECISIONS.md` §390). The organizer sets the price; the club only ever
