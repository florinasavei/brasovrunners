 ...
 * people there. Rendering the document itself brings it back, and brings two of the editor's
 * choices with it, neither of which means anything in a card:
 *
...
export const CARD_EXCERPT_SX = {
  ...
  "& p:last-of-type": { mb: 0 },
  // One class more specific than the figure's own rule, which is how the chosen width — a
  // media query from `sm` up — is overridden without `!important`.
  "& figure": { width: "100%", my: 1 },
