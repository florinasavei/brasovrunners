 ...
 * tooltip of its own (§261): the generic "Colaborare" marker (§367, §379, §NNN) in a tooltip
 ...
 *
 * No `sx` override for a filled (race) entry any more (§NNN): the `Handshake` glyph draws with no
