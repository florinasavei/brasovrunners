...
export default function CalendarEventChip({
  ...
  cancelled: boolean;
  note: EditionNote | null;
  /** "Eveniment de noapte: începe la 19:00, apusul la 16:36" / "Night event: starts at 19:00, sunset at 16:36" (§394, §NNN), made on the server — or null for a date that is not one. */
  night?: string | null;
