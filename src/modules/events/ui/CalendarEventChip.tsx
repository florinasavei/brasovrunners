 ...
 * the time and the title. A client island so `Tooltip` can hold a ref to its child and the
 ...
 * that on a tap, over the next two rows. The owner: "sunt destul de enervante".
 *
 * The link's `aria-label` is the whole sentence either way, so nothing is lost for a screen
 * reader when the tooltip is not there. 44px tall wherever it is (BR-REQ-041-01 criterion 6).
 */
