 ...
 * `ALIGN_STRETCH_MINUTES` past the interval while it gets there, which stays inside twice the
 * fastest pinger plus five; `tests/unit/jobs/schedule-alignment.test.ts` walks a day of runs, by
 * day and by night, against this very threshold.
 *
