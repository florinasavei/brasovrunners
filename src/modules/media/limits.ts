...
/**
 * The master's long side at «Minimă» (§NNN): a picture that only has to be seen — a map sketch,
...
/**
 * The master's long side at «Originală» (§NNN): the file's own pixels, up to 6000 — a 24-megapixel
