...
-- organizer's override of a computed answer. NULL is "Automat" (the start against civil dusk at the
-- club's place), true is "Da", false is "Nu". Expand only (AGENTS.md §7.6): the column is loosened,
