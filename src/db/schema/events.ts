...
export const events = pgTable(
  "events",
  {
     ...
     * Per row, so a series can carry it from October and drop it in April (the scope radio, §350).
     *
     * Not null with a default, so every row written before it reads as "no headlamp needed",
    ...
    /**
     * How many hours before the start this event's reminder goes (§81, §377): null is the club's
  ...
  (t) => [
    ...
    /**
     * A reminder lead an event can have (§377): none (zero) to a week, the club setting's own
