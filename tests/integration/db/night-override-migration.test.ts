...
/**
 * Migration `0075_night_override` (`DECISIONS.md` §NNN), proven on real PostgreSQL (PGlite): the
...
describe("§NNN migration 0075_night_override — the checkbox becomes an override", () => {
