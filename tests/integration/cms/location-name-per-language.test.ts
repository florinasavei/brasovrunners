...
/**
 * BR-REQ-011-01 criterion 30 (`DECISIONS.md` §362) — the meeting point, once per language.
 *
...
describe("BR-REQ-011-01 criterion 30 the meeting point, once per language (§362)", () => {
  let db: TestDatabase;
  ...
  describe("an event saved before §362", () => {
