...
/**
 * BR-REQ-031-05 and `AGENTS.md` §15.11 — withdrawing what was given on consent (§322).
 *
...
describe("BR-REQ-031-05 the participant withdraws their own health note and socials (§322)", () => {
  ...
  /**
   * §322 — two presses at once, from two doors, are one withdrawal. Without the lock both read
...
describe("AGENTS.md §15.11 an Administrator withdraws consent on the participant's behalf (§322)", () => {
