...
describe("BR-REQ-037-06 an Administrator erases a registration", () => {
  ...
  /**
   * §322 — erasing a person scrubs the trail of *whom*. A name correction kept the name before
  ...
  it("leaves no name and no participant id on any audit row of the erased registration", async () => {
    ...
    // A reason typed while the person was still somebody goes with them (§322): the
  ...
  /**
   * §322 — no "your registration is cancelled" to somebody who asked to be erased. The outbox row
