...
describe("§377 the club's deadlines, unset", () => {
  it("are the constants they replaced: 48 h link, 30 min hold, 24 h offer, 48 h reminder, 24 h check-in, 7-day race week, 56-day horizon — and the public list's 30 days (§NNN)", () => {
