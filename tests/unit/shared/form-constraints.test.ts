...
// `nightOverride` is the "Traseul" radio of three choices (§NNN), whose every answer — none too — is valid.
const NOT_A_BOX = new Set(["featured", "isSpecial", "nightOverride", "participantListVisibility", "bibDesign", "scheduleRows", "coHosts", "links", "locationAddress", "locationToBeAnnounced"]);
