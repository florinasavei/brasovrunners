...
describe("BR-REQ-031-04 the rendered form reaches the schema", () => {
  ...
  /**
   * §NNN — nationality and city are optional: nothing the club does with a registration reads
  ...
  /**
   * BR-REQ-072-01 is deferred (§NNN): the results consent is not on the form, a box posted anyway
