 ...
 * §NNN — how full the event is, read from the same numbers as the free-place count.
 *
...
test.describe("BR-REQ-030-01 the featured event leads to the registration form", () => {
  test("walks hero → register → submitted, and shows the free places on the way", async ({
    ...
    // §NNN public fill count: "N înscriși din 50 de locuri" — the same free-place count read the
