...
/**
 * BR-REQ-031-05, BR-REQ-060-01 — the data-handling pass (§NNN), walked in a browser.
 *
...
test.describe("BR-REQ-031-05 the emergency details, for the people they are for (§NNN)", () => {
...
test.describe("BR-REQ-031-05 the participant withdraws their own health note (§NNN)", () => {
...
test.describe("BR-REQ-060-01 everything held about a person, for the Administrator (§NNN)", () => {
