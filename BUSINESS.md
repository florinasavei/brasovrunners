...
The club can switch the anti-bot check on the registration and contact forms on or off from the backoffice, without a developer — because the day it starts refusing real people is the day it must be quickest to stop. The quieter defences stay on regardless (`DECISIONS.md` §254).
